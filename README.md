...
В версии 3.0+ произошел **глобальный рефакторинг**: старые скрипты `_Image_Builder.bat` и `_Source_Builder.bat` были удалены и заменены единым `_Builder`, который управляет обоими режимами.
