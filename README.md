...
Вот «причесанная» и профессионально оформленная версия FAQ для вашего GitHub. Я использовал структуру с выделением жирным, цитатами и иконками, чтобы информацию было легко сканировать глазами.
