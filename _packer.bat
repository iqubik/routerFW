...
(
    ...
    echo     set "file_hash="
    echo     for /f "delims=" %%%%H in ^('cmd /c powershell -NoProfile -Command "(Get-FileHash -Path ''!decode_target!'' -Algorithm MD5).Hash.ToLower()" 2^>nul'^) do set "file_hash=%%%%H"
