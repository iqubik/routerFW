...
### 1. Добавление сторонних пакетов из исходников (Тестировался на owrt 24.10.5 + z72.20251022)
...
### 2. Импорт бинарных пакетов (.ipk) в сборку (Механизм Binary-to-Source)
