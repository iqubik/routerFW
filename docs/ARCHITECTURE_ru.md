...
| `import`, `i` | `<id>` | Импорт .ipk в дерево профиля (только Source Builder). |
| `wizard`, `w` | — | Мастер создания нового профиля. |
| `clean`, `c` | `[тип] [id\|A]` | Очистка: тип 1–6 (Source) или 1–3 (Image); id или A = все. |
| `state`, `s` | — | Флаги профилей: где есть файлы/пакеты/сборки (F/P/S/…/OI/OS). |
