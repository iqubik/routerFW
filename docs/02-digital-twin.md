...
В результате в папке `profiles/` появится файл с именем по выбранному профилю (например, `cmcc_rax3000m-nand-mtk.conf`) с уже правильными техническими параметрами.
